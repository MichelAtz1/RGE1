...
public class AdapterListViewVisitaTecnica extends BaseAdapter {
    ...
    public AdapterListViewVisitaTecnica(Context context, ArrayList<DadosGerais> itens) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = mInflater.inflate(R.layout.list_item_visita, null);
        ((TextView) view.findViewById(R.id.txtMensagem)).setText(item.getTexto());
        ((ImageButton) view.findViewById(R.id.btnDeleteVisita)).setTag(position);
        return view;
    }
