...
public class AdapterListViewVegetacao extends BaseAdapter {
    ...
    public AdapterListViewVegetacao(Context context, ArrayList<DadosGerais> itens) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = mInflater.inflate(R.layout.list_item_vegetacao, null);
        ((TextView) view.findViewById(R.id.txtMensagem)).setText(item.getTexto());
        ((ImageButton) view.findViewById(R.id.btnDeleteVegetacao)).setTag(position);
        return view;
    }
