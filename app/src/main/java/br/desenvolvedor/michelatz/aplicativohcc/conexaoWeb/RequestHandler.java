...
public class RequestHandler {
    ...
    public String sendPostRequestTxt(String requestURL,
                                     HashMap<String, String> postDataParams) {
        ...
        try {
            ...
            OutputStream os = conn.getOutputStream();
            BufferedWriter writer = new BufferedWriter(
                    new OutputStreamWriter(os, "Cp1252"));
            writer.write(getPostDataStringTxt(postDataParams));
    ...
    private String getPostDataStringTxt(HashMap<String, String> params) throws UnsupportedEncodingException {
        StringBuilder result = new StringBuilder();
        boolean first = true;
        for (Map.Entry<String, String> entry : params.entrySet()) {
            if (first)
            ...
            result.append(URLEncoder.encode(entry.getKey(), "Cp1252"));
            result.append("=");
            result.append(URLEncoder.encode(entry.getValue(), "Cp1252"));
        }
